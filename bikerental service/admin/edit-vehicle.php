...
<div class="form-group">
<label class="col-sm-2 control-label">Price Per Day(in KES)<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<option value="4 Gears">4 Gears</option>
<option value="5 Gears">5 Gears</option>
<option value="6 Gears">6 Gears</option>
</select>
</div>
</div>
