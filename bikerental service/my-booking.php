...
<li>
                ...
                { ?>
                <div class="vehicle_status"> <a href="contact-us2.php" class="btn outline btn-xs active-btn">Confirmed</a>
                           <div class="clearfix"></div>

        </div>

              <?php } else if($result->Status==2) { ?>
 <div class="vehicle_status"> <a href="my-booking.php" class="btn outline btn-xs">Cancelled</a>
            <div class="clearfix"></div>
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a href="contact-us2.php" class="btn outline btn-xs">Not Confirm yet</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
