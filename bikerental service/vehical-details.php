      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            ...
            <img src="assets/images/mpesa.png" alt="image">
            <br><br/>
            <span>Business No : 247247</span>
            <br><br/>
            <span>Account No : 0470163395113</span>
            <br><br/>
            <span>Amount to pay</span>
            <br><br/>
            <span>=Number of days * price per day</span>
          </div>
          <form method="post">
            ...
            <div class="form-group">
              <textarea rows="4" class="form-control" name="M-pesa Transaction Id" placeholder="M-pesa Transaction Id" required></textarea>
            </div>
